...
if 1:
    ...
    parser.add_argument('--TRAIN_DATA',    type=str,    required=True,  help='path for training data')
    parser.add_argument('--VAL_DATA',      type=str,    required=True,  help='path for validation data')

    # hyperparameters
    parser.add_argument('-o', '--network_name', type=str, default='2DUnet', help='choose denoising network to use' )
...
dt = load_traindata(args['network_name'], args['TRAIN_DATA'])
